...
- b716507: Re-export `inferStandardErrorResponses`, `InferredStandardErrorResponses`,
...
- 53a9c3c: `TypedRegistry.registerPath` now auto-injects the standard framework-emitted
